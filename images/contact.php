...
?>
    ...
    <style>
        /* Contact Page Styles - Integrated with Main Theme */
        body.contact-page {
        ...
        /* Removed titleGlow animation for consistency */
        ...
        /* Removed duplicate hero styles - using theme variables */
        
        /* Contact Info Section - Theme Integrated */
        ...
        /* Removed background patterns for cleaner design */
    ...
    <script>
        ...
        // Form submission handling with auto-sync
        document.addEventListener('DOMContentLoaded', function() {
