...
$page_title = getTextContent('home_page_title', 'NextCode Group - Web Development & Digital Marketing');
$meta_description = getTextContent('home_meta_description', 'NextCode Group - Professional web development, digital marketing, and SEO services. Modern websites and digital solutions.');
$current_page = 'home';

// Get dynamic content from database
$hero_title = getTextContent('hero_title', 'NextCode Group');
$hero_subtitle = getTextContent('hero_subtitle', 'Modern Web Development & Digital Marketing Solutions');
$hero_description = getTextContent('hero_description', 'We create exceptional digital experiences that drive business growth and engage your audience.');
    ...
    if ($pdo) {
        $stmt = $pdo->query("
            SELECT bp.id, bp.title, bp.slug, bp.excerpt, bp.featured_image, 
                   bp.created_at, bc.name as category_name
            FROM blog_posts bp
...
$page_title = getTextContent('index_page_title', 'NextCode Group - Digital Marketing Agency');
$meta_description = getTextContent('index_meta_description', 'NextCode Group - Professional digital marketing services in Azerbaijan. SEO, social media, branding and advertising campaigns to grow your business.');
$current_page = 'home';
            ...
            <div class="modern-grid modern-grid--2">
                <div class="modern-animate--fadeInLeft">
                    ...
                    <div class="modern-flex modern-flex-wrap modern-m-8">
                        ...
                        <button class="modern-btn modern-btn--outline modern-btn--lg modern-m-4" id="heroVideoBtn" onclick="openVideoModal()">
                            <i class="fas fa-play me-2"></i>
                            <?php echo getTextContent('hero_video_text', 'Videomuzu İzleyin'); ?>
                        </button>
                    </div>
                ...
                <div class="modern-animate--fadeInRight modern-text-center">
                    <div class="modern-card modern-card--glass modern-p-8">
                        <div class="modern-card__body">
                            <div class="modern-badge modern-badge--primary modern-m-4" style="font-size: 4rem; width: 120px; height: 120px; display: flex; align-items: center; justify-content: center; margin: 0 auto;">
            ...
            <div class="modern-grid modern-grid--3">
                <div class="modern-card modern-animate--fadeInUp modern-animate--delay-1">
                    <div class="modern-card__body modern-text-center">
                        ...
                        <h3 class="modern-heading modern-heading--h4 modern-m-4"><?php echo getTextContent('service_seo_title', 'SEO Optimizasiya'); ?></h3>
                        <p class="modern-text modern-m-6">
                            <?php echo getTextContent('service_seo_description', 'Axtarış motorlarında yüksək reytinq əldə edin və daha çox müştəri cəlb edin. Google-da ilk səhifədə görünmək üçün peşəkar SEO strategiyaları.'); ?>
                        </p>
                        ...
                        <div class="modern-text modern-text--small modern-text-muted modern-m-4">
                            <i class="fas fa-chart-line me-2"></i> <?php echo getTextContent('service_seo_metric', 'Ortalama 300% trafik artışı'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="modern-card modern-animate--fadeInUp modern-animate--delay-2">
                    <div class="modern-card__body modern-text-center">
                        ...
                        <h3 class="modern-heading modern-heading--h4 modern-m-4"><?php echo getTextContent('service_social_title', 'Sosial Media İdarəetməsi'); ?></h3>
                        <p class="modern-text modern-m-6">
                            <?php echo getTextContent('service_social_description', 'Sosial şəbəkələrdə brendinizi gücləndirib auditoriya yaradın. Facebook, Instagram, LinkedIn və digər platformlarda peşəkar idarəetmə.'); ?>
                        </p>
                        <div class="modern-flex modern-flex-wrap modern-justify-center modern-m-6">
                        ...
                        <div class="modern-text modern-text--small modern-text-muted modern-m-4">
                            <i class="fas fa-heart me-2"></i> <?php echo getTextContent('service_social_metric', '85% engagement artışı'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="modern-card modern-animate--fadeInUp modern-animate--delay-3">
                    <div class="modern-card__body modern-text-center">
                        ...
                        <h3 class="modern-heading modern-heading--h4 modern-m-4"><?php echo getTextContent('service_branding_title', 'Brendinq və Dizayn'); ?></h3>
                        <p class="modern-text modern-m-6">
                            <?php echo getTextContent('service_branding_description', 'Unikal brend kimliyi yaradıb rəqiblərdən fərqlənin. Loqo dizaynından tam brend strategiyasına qədər bütün xidmətlər.'); ?>
                        </p>
                        <div class="modern-flex modern-flex-wrap modern-justify-center modern-m-6">
                        ...
                        <div class="modern-text modern-text--small modern-text-muted modern-m-4">
                            <i class="fas fa-award me-2"></i> <?php echo getTextContent('service_branding_metric', '50+ uğurlu brend layihəsi'); ?>
                        </div>
                    </div>
                </div>
                <div class="modern-card modern-animate--fadeInUp modern-animate--delay-4">
                    <div class="modern-card__body modern-text-center">
                        ...
                        <h3 class="modern-heading modern-heading--h4 modern-m-4"><?php echo getTextContent('service_advertising_title', 'Rəqəmsal Reklam Kampaniyaları'); ?></h3>
                        <p class="modern-text modern-m-6">
                            <?php echo getTextContent('service_advertising_description', 'Google Ads, Facebook Ads və digər platformlarda effektiv reklam strategiyaları ilə satışlarınızı artırın və ROI-nizi maksimallaşdırın.'); ?>
                        </p>
                        <div class="modern-flex modern-flex-wrap modern-justify-center modern-m-6">
                        ...
                        <div class="modern-text modern-text--small modern-text-muted modern-m-4">
                            <i class="fas fa-dollar-sign me-2"></i> <?php echo getTextContent('service_advertising_metric', 'Ortalama 450% ROI artışı'); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modern-grid modern-grid--3-cols modern-grid--gap-lg">
                    ...
                    <div class="modern-card__body">
                        <div class="modern-flex modern-items-center modern-gap-4 modern-m-6">
                            <div class="modern-card__image modern-card__image--avatar">
                                <?php echo getImageTag('testimonial1_image', 'https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=professional%20azerbaijani%20businessman%20headshot%20portrait%20smiling%20confident%20modern%20office%20background&image_size=square', 'Əli Məmmədov', ['class' => 'modern-card__image', 'loading' => 'lazy']); ?>
                            </div>
                ...
                <div class="modern-card modern-card--testimonial modern-animate--fadeInUp modern-animate--delay-2">
                    <div class="modern-card__body">
                        <div class="modern-flex modern-items-center modern-gap-4 modern-m-6">
                            <div class="modern-card__image modern-card__image--avatar">
                                <?php echo getImageTag('testimonial2_image', 'https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=professional%20azerbaijani%20businesswoman%20headshot%20portrait%20smiling%20confident%20modern%20office%20background&image_size=square', 'Leyla Həsənova', ['class' => 'modern-card__image', 'loading' => 'lazy']); ?>
                            </div>
                            <div class="modern-flex modern-flex-col">
                ...
                <div class="modern-card modern-card--testimonial modern-animate--fadeInUp modern-animate--delay-3">
                    <div class="modern-card__body">
                        <div class="modern-flex modern-items-center modern-gap-4 modern-m-6">
                            <div class="modern-card__image modern-card__image--avatar">
                                <?php echo getImageTag('testimonial3_image', 'https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=young%20azerbaijani%20entrepreneur%20headshot%20portrait%20creative%20startup%20office%20background&image_size=square', 'Rəşad Quliyev', ['class' => 'modern-card__image', 'loading' => 'lazy']); ?>
                            </div>
                            <div class="modern-flex modern-flex-col">
    ...
    <div id="videoModal" class="video-modal" style="display: none;">
        <div class="video-modal-content">
            ...
            <div class="video-container">
                <!-- Kendi Video Dosyanız -->
                <video id="videoPlayer" width="100%" height="315" controls preload="metadata" poster="images/video-poster.jpg">
                    <source src="videos/Видео WhatsApp 2025-10-04 в 15.31.15_0010b383.mp4" type="video/mp4">
                    Tarayıcınız video etiketini desteklemiyor.
                </video>
                
                <!-- Alternatif: YouTube Video Embed -->
                <!--
