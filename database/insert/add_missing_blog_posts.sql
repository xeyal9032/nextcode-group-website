-- Eksik Blog Yazılarını Ekleme
-- Mevcut veritabanına eksik blog yazılarını ekler

USE `gtorg_nextcode`;

-- Eksik blog yazılarını ekle
...
9, -- Kibertəhlükəsizlik kategorisi ID
NULL, 
'published', 
1, 
...
SELECT 'Eklenen Blog Yazıları:' as 'Sonuç';
SELECT `id`, `title`, `slug`, `category_id`, `status` FROM `blog_posts` WHERE `id` IN (3, 4, 5) ORDER BY `id`;
