-- NextCode Group - Güvenli Veritabanı Güncelleme
-- MySQL 5.7 uyumlu, hata toleranslı güncelleme scripti

USE `gtorg_nextcode`;

-- ==============================================
-- EKSİK TABLOLARI EKLE (HATA TOLERANSLI)
-- ==============================================
...
-- ==============================================
-- SÜTUN EKLEME PROCEDURE'LERİ
-- ==============================================

DELIMITER $$

-- portfolio_projects tablosuna sütun ekleme procedure'ü
CREATE PROCEDURE AddColumnIfNotExists()
BEGIN
    DECLARE CONTINUE HANDLER FOR 1060 BEGIN END; -- Duplicate column name
    
    -- portfolio_projects sütunları
