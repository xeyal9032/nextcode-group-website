...
if (empty($projects)) {
    $projects = [
        ...
        [
            ...
            'featured_image' => 'https://images.unsplash.com/photo-1518186285589-2f7649de83e0?w=800&h=600&fit=crop&crop=center',
        ...
        [
            ...
            'featured_image' => 'https://images.unsplash.com/photo-1434494878577-86c23bcb06b9?w=800&h=600&fit=crop&crop=center',
...
@keyframes spin {
    ...
    <section class="modern-section modern-section--hero main-content">
        <div class="modern-container">
            <div class="modern-text-center">
                ...
                <h1 class="modern-heading modern-heading--xl">Portfolio</h1>
                <p class="modern-text modern-text--lg">
                    Yaradıcı layihələrimizi kəşf edin və rəqəmsal dünyada yaratdığımız təsirli həlləri görün
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="modern-section">
        ...
        <div class="modern-flex modern-flex-wrap modern-justify-center modern-m-8">
            <button class="modern-btn modern-btn--ghost modern-btn--sm modern-m-2 active" data-filter="all">Hamısı</button>
        ...
        <!-- Portfolio Loading -->
        <div class="modern-text-center modern-hidden" id="portfolioLoading">
            <div class="modern-m-4">
                <i class="fas fa-spinner fa-spin" style="font-size: 2rem; color: var(--primary-color);"></i>
            </div>
            <p class="modern-text">Layihələr yüklənir...</p>
        </div>
                                ...
                                <div class="modern-portfolio-overlay">
                                    <div class="modern-portfolio-actions">
                                        <a href="portfolio-detail.php?id=<?php echo $project['id']; ?>" class="modern-btn-action">
                                            <i class="fas fa-eye me-2"></i> Təfərrüatları Gör
                                        </a>
                    ...
                    <div class="modern-card modern-text-center">
                        <div class="modern-card__body">
                            <div class="modern-alert modern-alert--info">
                                <h4 class="modern-heading modern-heading--h4">Henüz layihə yoxdur</h4>
                                <p class="modern-text">Tezliklə möhtəşəm layihələr əlavə olunacaq!</p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Layihə Təfərrüatları</h5>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initModernImageLoading() {
        ...
        .then(data => {
            if (data.success) {
                ...
                modalBody.innerHTML = `
                    <div class="row">
                        <div class="col-md-6">
                            <img src="${project.image_url}" class="img-fluid rounded" alt="${project.title}">
                        </div>
                        <div class="col-md-6">
...
document.addEventListener('error', function(e) {
    if (e.target.tagName === 'IMG') {
        e.target.src = 'images/portfolio/placeholder.svg';
