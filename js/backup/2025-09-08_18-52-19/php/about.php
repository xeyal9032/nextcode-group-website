...
$page_title = 'About - NextCode Group';
$meta_description = 'Learn about NextCode Group team. Meet our experienced specialists and our success story.';
$current_page = 'about';
...
?>
                        <button id="themeToggle" class="btn btn-outline-secondary btn-sm me-2" title="Tema Dəyiş">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-primary ms-2" href="contact.php">Contact Us</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="modern-grid modern-grid--2-cols modern-grid--gap-lg">
                ...
                <div class="modern-animate--fadeInRight">
                    <div class="modern-card modern-card--image">
                        <img src="https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=modern%20digital%20marketing%20team%20working%20together%20in%20office%2C%20professional%20atmosphere%2C%20laptops%20and%20charts%2C%20bright%20lighting&image_size=landscape_4_3" alt="Komandamız" class="modern-card__image" loading="lazy">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="modern-section modern-section--light">
        <div class="modern-container">
            <div class="modern-text-center modern-m-8">
                <h2 class="modern-heading modern-heading--lg">Rəqəmlərlə Uğurumuz</h2>
            </div>
            <div class="modern-grid modern-grid--4-cols modern-grid--gap-md">
                <div class="modern-card modern-card--stat modern-animate--fadeInUp modern-animate--delay-1">
                    <div class="modern-card__body modern-text-center">
                        ...
                        <div class="modern-heading modern-heading--xl modern-text--gradient">250+</div>
                        <div class="modern-text modern-text--sm">Məmnun Müştəri</div>
                    </div>
                </div>
                <div class="modern-card modern-card--stat modern-animate--fadeInUp modern-animate--delay-2">
                    <div class="modern-card__body modern-text-center">
                        ...
                        <div class="modern-heading modern-heading--xl modern-text--gradient">500+</div>
                        <div class="modern-text modern-text--sm">Tamamlanmış Layihə</div>
                    </div>
                </div>
                <div class="modern-card modern-card--stat modern-animate--fadeInUp modern-animate--delay-3">
                    <div class="modern-card__body modern-text-center">
                        ...
                        <div class="modern-heading modern-heading--xl modern-text--gradient">16+</div>
                        <div class="modern-text modern-text--sm">İl Təcrübə</div>
                    </div>
                </div>
                <div class="modern-card modern-card--stat modern-animate--fadeInUp modern-animate--delay-4">
                    <div class="modern-card__body modern-text-center">
                        ...
                        <div class="modern-heading modern-heading--xl modern-text--gradient">95%</div>
                        <div class="modern-text modern-text--sm">Müştəri Məmnuniyyəti</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modern-container">
            ...
            <div class="modern-grid modern-grid--4-cols modern-grid--gap-md">
                ...
                <div class="modern-card modern-card--team modern-animate--fadeInUp modern-animate--delay-2">
                    <div class="modern-card__image">
                        <img src="https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=professional%20female%20marketing%20director%20portrait%2C%20business%20attire%2C%20friendly%20smile%2C%20modern%20office&image_size=square" alt="Leyla Həsənova" class="modern-card__image" loading="lazy">
                    </div>
                    <div class="modern-card__body modern-text-center">
