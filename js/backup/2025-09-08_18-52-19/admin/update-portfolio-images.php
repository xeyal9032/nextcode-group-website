...
echo "Updating portfolio images...\n";

// Define image mappings for each project
$imageUpdates = [
    1 => '/images/portfolio/corporate-website.jpg',           // Modern Kurumsal Web Sitesi
    2 => '/images/portfolio/ai-chatbot.jpg',                  // AI Destekli Müşteri Analiz Platformu
    3 => '/images/portfolio/ecommerce-project.jpg',           // E-Ticaret Platformu
    4 => '/images/portfolio/mobile-app.jpg',                 // Mobil Fitness Uygulaması
    5 => '/images/portfolio/healthcare-saas.svg',            // SaaS CRM Sistemi
    6 => '/images/portfolio/crypto-tracker.svg',              // Kripto Para Cüzdan Uygulaması
    7 => '/images/portfolio/healthcare-saas.svg',            // Hastane Yönetim Sistemi
    8 => '/images/portfolio/marketplace.svg',                // Çok Kanallı E-ticaret Platformu
    9 => '/images/portfolio/neural-visualizer.svg',           // Finansal Analiz Dashboard
    10 => '/images/portfolio/mobile-app.jpg',                 // Mobil Bankacılık Uygulaması
    11 => '/images/portfolio/smart-city.svg',                 // IoT Akıllı Ev Platformu
    12 => '/images/portfolio/project-management.svg',         // Sosyal Medya Yönetim Platformu
    13 => '/images/portfolio/placeholder.svg',                // Oyun Geliştirme Platformu
    14 => '/images/portfolio/responsive-design.jpg',          // Restoran Zinciri Rebrand
    15 => '/images/portfolio/ai-content-generator.svg',      // Dijital Pazarlama Kampanyası
    16 => '/images/portfolio/project-management.svg'          // Eğitim Platformu
];

foreach ($imageUpdates as $id => $imagePath) {
    $stmt = $pdo->prepare("UPDATE portfolio_projects SET featured_image = ? WHERE id = ?");
    $stmt->execute([$imagePath, $id]);
    echo "✅ Updated project $id image: $imagePath\n";
}

echo "Portfolio images updated successfully!\n";

// Also update project titles and descriptions to match the website
$projectUpdates = [
    1 => [
